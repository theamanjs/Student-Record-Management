    ...
    <div class="modal-content">
      ...
      <form class="custom_add_form" method="post" id="addAssignmentForm">
        ...
        <div class="form-group col-12">
            <label for="assignment-file" class="bmd-label-floating">Document Attachment</label>
            <input type="file" name="assignment-file" id="assignment-file">
            <a href="#" class="btn btn-sm btn-primary float-right" onclick="$('#assignment-file').trigger('click');">Select File</a>
        </div>
        ...
        <div class="row">
         ...
         <div class="form-group col-12 pr-4 text-right">
            <button class="btn btn-primary ml-2 custom-search-button" type="button" onclick="addAssignment()">Submit</button>
        </div>
        </form>
      </div>
    </div>
...
<button id="loadMoreButton" onclick="loadMoreAssignments()" class="btn btn-primary attendanceSubmit">Show More</button>
<div>
                        ...
                        for(let i = init; i <= countLength; i++) {
                            assignments += `<div class="card card-collapse">
                                        <div class="card-header" role="tab" id="heading${i}">
                                          <h5 class="mb-0">
                                            <a data-toggle="collapse" href="#collapse${i}" aria-expanded="false" aria-controls="collapse${i}">
                                              ${assignmentArray[i][2]} (No.-${assignmentArray[i][3]}) (${assignmentArray[i][1]})
                                        ...
                                        <div id="collapse${i}" class="collapse" role="tabpanel" aria-labelledby="heading${i}" data-parent="#accordion">
                                          <div class="card-body">
                                            ${assignmentArray[i][5]} <a href="${assignmentArray[i][4]}">Download Attachment</a>
                                          </div>
                                        </div>
                                      </div>`;
                        }
