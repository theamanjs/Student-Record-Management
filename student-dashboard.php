  ...
  <div class="modal-dialog" style="max-width:700px;" role="document">
    <div class="modal-content">
      <div class="modal-header custom_modal_header">
        <h5 class="modal-title custom_modal_title">Practical Lectures Chart</h5>
...
<div class="modal" tabindex="-1" role="dialog" id="modalTheory">
  <div class="modal-dialog" style="max-width:700px;" role="document">
    <div class="modal-content">
      <div class="modal-header custom_modal_header">
        <h5 class="modal-title custom_modal_title">Theory Lectures Chart</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
                            ...
                            <div class="my-4">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between card-header-primary">
                                        ...
                                        <button class="btn btn-primary m-0 custom-chart-button" data-toggle="modal" data-target="#modalPractical">View Chart</button>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="my-4 pt-3">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between card-header-primary">
                                        ...
                                        <button class="btn btn-primary m-0 custom-chart-button" data-toggle="modal" data-target="#modalTheory">View Chart</button>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table text-center">
