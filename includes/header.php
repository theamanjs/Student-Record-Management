...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
    <div class="container-fluid">
        ...
        if($_SESSION['userType'] != 'Student'){
            ...
            <input name="searched-roll" type="text" value="" class="form-control" placeholder="Search Roll" required>
                        <button name="find-roll" type="submit" class="btn btn-white btn-round btn-just-icon customSearchButton">
            ...
            <ul class="navbar-nav">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="changeTheme" style="min-width: 231px; padding-left:5px;">
                ...
                <li class="nav-item dropdown">
                    ...
                    <?php
                    if($_SESSION['userType'] != 'Student'){
                        echo '<a class="dropdown-item" href="./password.php">Password</a>';
                    }
                    ?>       
